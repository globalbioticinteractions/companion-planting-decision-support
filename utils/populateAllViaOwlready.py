...
with onto:
    ...
    ThreeCompanionGarden = types.new_class("ThreeCompanionGarden", (Garden,))
    ThreeTripleCompanionGarden = types.new_class("ThreeTripleCompanionGarden", (Garden,))
    ...
    #types.new_class("suppressesPestsFor", (companionWith,))
    increasedLevelInteractionFor = types.new_class("increasedLevelInteractionFor", (companionWith,))
    providesNutrientsFor = types.new_class("providesNutrientsFor", (increasedLevelInteractionFor,))
    ...
    protectiveShelterFor = types.new_class("protectiveShelterFor", (increasedLevelInteractionFor,))
    providesShadeFor = types.new_class("providesShadeFor", (increasedLevelInteractionFor,))
    providesWaterFor = types.new_class("providesWaterFor", (increasedLevelInteractionFor,))
    providesWindProtectionFor = types.new_class("providesWindProtectionFor", (increasedLevelInteractionFor,))
